...
public class HomePageTest extends DriverInit {
   ...
   @Test(priority = 1)
	public void verifyHomePageTitleTest() throws IOException, InterruptedException {
	   ...
	   System.out.println("home page title==>"+ homePage.validateHomePageTitle());
		Assert.assertEquals(homePage.validateHomePageTitle(), TestUtil.readDataFromExcellString(5, 1, 0),"We are navigate to Home page");
	...
	public void verifyVisaCategoriesTest() throws IOException,
		...
		TestUtil.writeStringValue(5, 2, 1);
