...
public class CNLoginTest extends DriverInit {
	...
	public void loginfunctionaltyTest1() throws InterruptedException {
		xlsReaderMethod();
	...
	public void loginfunctionaltyTest2() throws InterruptedException {
		xlsReaderMethod();
		int rowCount = reader.getRowCount("CNLoginPage");
		for (int rowNumb = 2; rowNumb <= rowCount; rowNumb++) {
	...
	public void loginfunctionaltyTest3() throws InterruptedException {
		xlsReaderMethod();
		int rowCount = reader.getRowCount("CNLoginPage");
		for (int rowNumb = 2; rowNumb <= rowCount; rowNumb++) {
	...
	public void loginfunctionaltyTest4() throws InterruptedException {
		xlsReaderMethod();
		int rowCount = reader.getRowCount("CNLoginPage");
		for (int rowNumb = 2; rowNumb <= rowCount; rowNumb++) {
	...
	public void loginfunctionaltyTest5() throws InterruptedException {
		xlsReaderMethod();
		int rowCount = reader.getRowCount("CNLoginPage");
		for (int rowNumb = 2; rowNumb <= rowCount; rowNumb++) {
