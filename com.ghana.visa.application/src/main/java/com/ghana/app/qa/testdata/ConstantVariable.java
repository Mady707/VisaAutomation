...
public class ConstantVariable {
	...
	//TestData
	public static int totalPassportTypeInReq=6;
	public static int totalCountryListInReq=251;
	public static int totalPortArrivalInReq=2;
	public static int totalVisaTypeExpecteed=12;
	public static int totalVisaLocationExpected=4;
	public static int totalModeOfConsulateExpected=3;
	public static int totalCountryResidenceexpected=251;
	
	public static String nationalityName = "India"; // India,
	public static String portOfArrival = "Kotoka Accra Airport";
	public static int totalCountryBirthListInReq=501;
	public static int totalOcupationListInReq=29;
	...
	public static String formerNationality = "None";
