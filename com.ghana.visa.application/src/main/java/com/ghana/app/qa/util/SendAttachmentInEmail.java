...
public class SendAttachmentInEmail {
	...
	public static void main(String[] args) throws InterruptedException {
	   ...
	   final String password = TestUtil.prop.getProperty("password"); //" ";//change accordingly	
	   String host = "smtp.googlemail.com";
	   
	  String ExtendfilePath= driverPath+"\\test-output\\ExtentReport.html";
     
	  String emailablePath= driverPath+"\\test-output\\emailable-report.html";
	  ...
	  public void sentScreenShot(){
		  ...
		  Session session = Session.getDefaultInstance(props,
		    ...
		    System.out.println("Attach capture screenshot and here is screenshot name ==>"+screenshotName);
		       ...
		       message.setSubject("Testing Report with Extend and TestNG report");
		       //
		       BodyPart messageBodyPart = new MimeBodyPart();
		       messageBodyPart.setText(ExtendfilePath);
	...
	public void email() throws InterruptedException
	  ...
	  Session session = Session.getDefaultInstance(props,
	        ...
	        try {
		       ...
		       Thread.sleep(5000);	
		       if(OSName.equalsIgnoreCase("Mac")){
		    		filename = driverPath+"/test-output/ExtentReport.html"; 
			    	   DataSource source = new FileDataSource(filename);
			    	   messageBodyPart.setDataHandler(new DataHandler(source));
			    	     messageBodyPart.setFileName(filename);  
		       }
		       else if(OSName.equalsIgnoreCase("Win")){
		    		filename = driverPath+"\\test-output\\ExtentReport.html"; 
			    	   DataSource source = new FileDataSource(filename);
			    	   messageBodyPart.setDataHandler(new DataHandler(source));
			    	     messageBodyPart.setFileName(filename); 
			    	     
			    	     messageBodyPart.setContent(filename, "text/html");	 
	       ...
	       try {
		   	    ...
		   	    messageBodyPart2.setText(emailablePath);
